<%@ Control Language="C#" AutoEventWireup="true" CodeFile="7.0.0.ascx.cs" Inherits="bitrix_admin_controls_SiteUpdater_UpdateSystem_7_0_0" %>
...
<asp:Panel ID="LicenseDataPanel" runat="server" Width="100%">
	<asp:UpdatePanel ID="LicenseDataPanelUpdatePanel" runat="server">
		<ContentTemplate>
			<table class="BXUpdateSystem" width="100%" cellpadding="3" cellspacing="0">
				<tr>
					<td class="HasUpdatesTop"><div class="icon icon-update">&nbsp;</div></td>
					<td colspan="3" class="HasUpdatesTop"><%= GetMessageRaw("RefreshLicenseData") %></td>
				</tr>
				<tr>
					<td width="30" class="HasUpdatesBody">&nbsp;</td>
					<td width="100%" class="HasUpdatesBody">
						<%= GetMessageRaw("InvalidLicenseData") %>
						<asp:Label ID="LicenseDataError" runat="server" CssClass="BXUpdateSystemError" Visible="False" EnableViewState="false" />
						<asp:Label ID="LicenseDataSuccess" runat="server" Font-Bold="true" Visible="False" EnableViewState="false"><br /><br /><%= GetMessageRaw("LicenseDataRefreshed") %></asp:Label>
						<br /><br />
						<asp:Button runat="server" ID="RequestLicenseData" Text="<%$ LocRaw:ButtonText.RequestLicenseData %>" OnClick="RequestLicenseData_Click" />
					</td>
					<td width="30" class="HasUpdatesBody">&nbsp;</td>
					<td width="0%" align="right" valign="top" class="HasUpdatesBody">						
						<asp:UpdateProgress ID="UpdateProgress6" runat="server" AssociatedUpdatePanelID="CouponUpdatePanel">
							<ProgressTemplate>
