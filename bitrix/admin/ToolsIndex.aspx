<%@ Page Language="C#" MasterPageFile="~/bitrix/admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="ToolsIndex.aspx.cs" Inherits="bitrix_admin_ToolsIndex" Title="<%$ Loc:PageTitle.Tools %>" %>
