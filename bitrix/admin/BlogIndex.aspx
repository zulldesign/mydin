<%@ Page Language="C#" MasterPageFile="~/bitrix/admin/AdminMasterPage.master" AutoEventWireup="false" CodeFile="BlogIndex.aspx.cs" Inherits="bitrix_admin_BlogIndex" Title="<%$ LocRaw:PageTitle %>" %>
