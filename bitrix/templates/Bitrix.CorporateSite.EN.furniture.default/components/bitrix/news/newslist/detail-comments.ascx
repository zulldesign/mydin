...
<script runat="server">
    protected override void OnInit(EventArgs e)
    {
        ...
        News parentComponent = null;
        while (parentComponent == null && parent != null && parent != Page)
        {
            parentComponent = parent as News;
        ...
        ForumCommentBlockComponent component = (ForumCommentBlockComponent)commentBlock.Component;
        component.TopicCreatedHandler =
        ...
        BXComponentParameters commentParams = component.Parameters;
