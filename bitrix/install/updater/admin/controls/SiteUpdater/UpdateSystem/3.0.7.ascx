<%@ Control Language="C#" AutoEventWireup="true" CodeFile="3.0.7.ascx.cs" Inherits="bitrix_admin_controls_SiteUpdater_UpdateSystem_3_0_7" %>
...
<bx:BXContextMenuToolbar ID="BXContextMenuToolbar1" runat="server">
	<Items>
		...
		<bx:BXCmImageButton ID="BXCmImageButton1" runat="server"
			CommandName="Refresh" Text="<%$ Loc:ActionText.CheckForUpdates %>" OnClickScript="location.reload(true);" />
		<bx:BXCmSeparator ID="BXCmSeparator2" runat="server">
		</bx:BXCmSeparator>
		<bx:BXCmImageButton ID="BXCmImageButton2" runat="server"
			CommandName="ChangeSettings" Text="<%$ Loc:ActionText.ChangeSetings %>" OnClickScript="window.location=&quot;UpdateSystemSettings.aspx&quot;">
		</bx:BXCmImageButton>
						...
						<td colspan="2" class="HasUpdatesBody">
							...
							<table cellspacing="3" cellpadding="3">
								...
								<tr>
									<td colspan="2">
									<%= string.Format(
									    GetMessage("FormatProductSiteRegistrationComment"),
									    "<a href=\"http://www.bitrixsoft.ru\" target=\"_blank\">www.bitrixsoft.ru</a>",
                                        "www.bitrixsoft.ru",
									    "<a href=\"http://www.bitrixsoft.ru/support/\" target=\"_blank\">", "</a>",
									    "<a href=\"http://www.bitrixsoft.ru/support/forum/\" target=\"_blank\">", "</a>"                                                                                                                    
                                        )%>
									</td>
								</tr>
								<tr>
