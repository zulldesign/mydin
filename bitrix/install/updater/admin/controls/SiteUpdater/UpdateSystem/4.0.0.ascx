<%@ Control Language="C#" AutoEventWireup="true" CodeFile="4.0.0.ascx.cs" Inherits="bitrix_admin_controls_SiteUpdater_UpdateSystem_4_0_0" %>
<bx:BXContextMenuToolbar ID="BXContextMenuToolbar1" runat="server">
	<Items>
		...
		<bx:BXCmImageButton ID="BXCmImageButton3" runat="server" CssClass="context-button icon"
			CommandName="ViewHistory" Text="Посмотреть историю обновлений" OnClickScript="window.location.href=&quot;UpdateSystemLog.aspx&quot;">
		</bx:BXCmImageButton>--%>
	</Items>
