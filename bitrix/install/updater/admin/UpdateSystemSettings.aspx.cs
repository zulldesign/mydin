...
public partial class bitrix_admin_UpdateSystemSettings : BXAdminPage, IComparer<BXUpdaterVersion>
{
	const string ControlsPath = "~/bitrix/admin/controls/SiteUpdater/UpdateSystemSettings/";
