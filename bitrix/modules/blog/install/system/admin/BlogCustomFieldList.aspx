<%@ Page Language="C#" AutoEventWireup="false"
    ...
    CodeFile="BlogCustomFieldList.aspx.cs" Inherits="bitrix_admin_BlogCustomFieldList" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
	    <ContentTemplate>
		    ...
		    <bx:BXContextMenuToolbar ID="BXContextMenuToolbar1" runat="server" OnCommandClick="BXContextMenuToolbar1_CommandClick">
			    <Items>
				    <bx:BXCmImageButton ID="AddForPostButton" runat="server" CssClass="context-button icon btn_new" CommandName="addForPost"
					    Text="<%$ Loc:ButtonCaption.AddCustomFieldForPost %>" Title="<%$ Loc:ButtonCaption.AddCustomFieldForPost %>" />
				    <bx:BXCmImageButton ID="AddForBlogButton" runat="server" CssClass="context-button icon btn_new" CommandName="addForBlog"
					    Text="<%$ Loc:ButtonCaption.AddCustomFieldForBlog %>" Title="<%$ Loc:ButtonCaption.AddCustomFieldForBlog %>" />					    
			    </Items>
		    ...
		    <bx:BXGridView ID="BXGridView1" DataSourceID="BXGridView1" runat="server" OnDelete="BXGridView1_Delete"
			    ...
			    <Columns>
				    ...
				    <asp:TemplateField HeaderText="<%$ Loc:ColumnContext %>" 
					    ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle" >
					    <itemtemplate><%# Encode(GetContextName((string)Eval("OwnerEntityId")))%></itemtemplate>
				    </asp:TemplateField>				    				    
				    ...
				    <asp:TemplateField Visible="False" SortExpression="ShowInFilter" HeaderText="<%$ Loc:FilterText.Filter %>"
					    ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle" >
					    <itemtemplate><%# Encode(GetFilterVisibilityCaption((Bitrix.BXCustomFieldFilterVisibility)Eval("ShowInFilter")))%></itemtemplate>	
				    </asp:TemplateField>
