<%@ Page Language="C#" MasterPageFile="~/bitrix/admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="SearchSettingsIndex.aspx.cs" Inherits="bitrix_admin_SearchSettingsIndex" Title="<%$ Loc:PageTitle.Content %>" %>
