...
<script runat="server">
	...
	{
		new KeyValuePair<string, string>("main", "Top menu"),
		new KeyValuePair<string, string>("submenu", "Section menu"),
	...
	protected override BXWizardResult OnActionNext(Bitrix.DataTypes.BXCommonBag parameters)
	{
		...
		UI.SetProgressBarValue("Installer.ProgressBar", "Bitrix.CommunitySite", 4);
		return Result.Next();
	}
