...
<script runat="server">
	...
	protected override void OnWizardInit()
	{
		...
		parameters["Slogan"] = File.Exists(slogan) ? File.ReadAllText(slogan, Encoding.UTF8) : "Company slogan\r\n<br />placeholder";
...
<div class="wizard-input-form">
	<div class="wizard-input-form-block">
		<h4>Logo (recommended size: 210 X 60)</h4>
	...
	<div class="wizard-input-form-block">
		<h4>Banner (recommended size: 400 Х 140)</h4>
		<div class="wizard-input-form-block-content">
