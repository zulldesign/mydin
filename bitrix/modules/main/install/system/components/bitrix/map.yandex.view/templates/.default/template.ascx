<%@ Reference VirtualPath="~/bitrix/components/bitrix/map.yandex.view/component.ascx" %>
<%@ Control Language="C#" AutoEventWireup="false" Inherits="MapYandexViewComponentTemplate" %>
...
<script runat="server">    
    protected override void OnPreRender(EventArgs e)
    {
        ...
        if (Component.ComponentErrors != MapYandexViewComponentError.None)
            return;
