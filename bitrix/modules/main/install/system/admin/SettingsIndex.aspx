<%@ Page Language="C#" MasterPageFile="~/bitrix/admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="SettingsIndex.aspx.cs" Inherits="bitrix_admin_SettingsIndex" Title="<%$ Loc:Kernel.TopPanel.Settings %>" %>
