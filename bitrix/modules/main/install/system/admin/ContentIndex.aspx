<%@ Page Language="C#" MasterPageFile="~/bitrix/admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="ContentIndex.aspx.cs" Inherits="bitrix_admin_ContentIndex" Title="<%$ Loc:PageTitle.Content %>" %>
