<%@ Control Language="C#" AutoEventWireup="true" CodeFile="AdminWizard.ascx.cs" Inherits="Bitrix.UI.AdminWizard" %>
<%@ Register TagPrefix="bx" TagName="Wizard" Src="AdminWizardHost.ascx" %>
<html>
	<head>
        ...
        <script type="text/javascript" src="<%= System.Web.VirtualPathUtility.ToAbsolute("~/bitrix/js/main/utils.js") %>"></script>
        <script type="text/javascript" src="<%= System.Web.VirtualPathUtility.ToAbsolute("~/bitrix/js/main/utils_net.js") %>"></script>
