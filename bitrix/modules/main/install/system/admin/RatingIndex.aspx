<%@ Page Language="C#" MasterPageFile="~/bitrix/admin/AdminMasterPage.master" AutoEventWireup="false" CodeFile="RatingIndex.aspx.cs" Inherits="bitrix_admin_RatingIndex" Title="<%$ LocRaw:PageTitle %>" %>
