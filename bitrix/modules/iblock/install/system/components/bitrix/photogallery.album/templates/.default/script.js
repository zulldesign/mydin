...
//                catch (e) {}
        ...
        SlideSlider.ShowItemDetails = function(item_id) 
        {
            ...
            var template_vars = {
                ...
                url: /\#url\#/gi,
                voting_html: /\#voting_html\#/gi,
                voting_result: /\#voting_result\#/gi,
                commenturl: /\#commenturl\#/gi
                };
            ...
            if (this.oSource.Data[item_id])
				this.refreshVoting(this.oSource.Data[item_id].voting_result, this.oSource.Data[item_id].voting_allowed);
            setTimeout(function() {
                __this.status = 'ready'; 
