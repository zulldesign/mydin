<%@ Control Language="C#" AutoEventWireup="true" CodeFile="template.ascx.cs" Inherits="bitrix_components_bitrix_photogallery_photo_templates__default_template" %>
...
<div class="fields">
    ...
    <div class="field">
            ...
            <div class="form-input">
            <asp:DropDownList ID="lbSections" Rows="15" SelectionMode="Multiple" runat="server"></asp:DropDownList>
            </div>
     </div>
    <div class="field">
