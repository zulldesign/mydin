<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductList.aspx.cs" Inherits="mydin.ProductList" Title="Products" MasterPageFile="~/Site.Master" %>
                 ...
                 <section class="featured">
                    <ul> 
                        <asp:ListView ID="productList" runat="server"
                            ...
                            GroupItemCount="3" ItemType="mydin.Models.Product" SelectMethod="GetProducts">
                            <EmptyDataTemplate>      
